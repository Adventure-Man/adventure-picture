...
public class PictureTableDef extends TableDef {
 ...
 @since 2025-07-17
     ...
     * 图片主色调
     */
    public final QueryColumn PIC_COLOR = new QueryColumn(this, "picColor");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, URL, NAME, TAGS, USER_ID, PIC_SIZE, SPACE_ID, CATEGORY, EDIT_TIME, IS_DELETE, PIC_COLOR, PIC_SCALE, PIC_WIDTH, PIC_FORMAT, PIC_HEIGHT, CREATE_TIME, REVIEW_TIME, REVIEWER_ID, UPDATE_TIME, INTRODUCTION, REVIEW_STATUS, THUMBNAIL_URL, REVIEW_MESSAGE};
