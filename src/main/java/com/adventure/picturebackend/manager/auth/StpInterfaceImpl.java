...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (!StpKits.SPACE_TYPE.equals(loginType)) {
            return new ArrayList<>();
        }
        // 管理员权限，表示权限校验通过
        final List<String> ADMIN_PERMISSIONS = spaceUserAuthManager.getPermissionsByRole(SpaceRoleEnum.ADMIN.getValue());
        // 获取上下文对象
        ...
        // 获取 userId
        User loginUser = (User) StpKits.SPACE.getSessionByLoginId(loginId).get(USER_LOGIN_STATE);
        if (loginUser == null) {
        ...
        if (spaceUserId != null) {
            ...
            SpaceUser loginSpaceUser = spaceUserService.getOne(new QueryWrapper()
        ...
        // 根据 Space 类型判断权限
        if (space.getSpaceType() == SpaceTypeEnum.PRIVATE) {
            // 私有空间，仅本人或管理员有权限
            ...
            spaceUser = spaceUserService.getOne(new QueryWrapper()
...
//        HttpServletRequest httpServletRequest = (HttpServletRequest)ServletRequestAttributes;
