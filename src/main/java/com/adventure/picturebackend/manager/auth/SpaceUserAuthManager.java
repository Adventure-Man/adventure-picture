...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionList(Space space, User loginUser) {
        ...
        if (space == null) {
            ...
            return Arrays.asList(SpaceUserPermissionConstant.PICTURE_VIEW);
        }
        SpaceTypeEnum spaceTypeEnum = space.getSpaceType();
        ...
        switch (spaceTypeEnum) {
            ...
            case TEAM:
                ...
                SpaceUser spaceUser = spaceUserService.getOne(new QueryWrapper()
